...
cat >> "$OUTPUT_FILE" << 'EOF'
    /// Creates the embedded templates as files in a persistent directory
    ...
    static func createTempViewsDirectory() throws -> String {
        ...
        let viewsDir = workingDirectory + "embedded_views"
...
cat >> "$OUTPUT_FILE" << 'EOF'
        ...
        print("📁 Created persistent embedded templates in: \(viewsDir)")
        return viewsDir
    }
}
EOF
